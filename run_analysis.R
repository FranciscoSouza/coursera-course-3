...
##Step : 3 Extract the measurements on the mean and standard deviation for each measurement.
# determine which columns contain "mean()" or "std()"
meansTdColumns <- grepl("mean\\(\\)", names(combined)) |
...
combined <- combined[, meansTdColumns]
